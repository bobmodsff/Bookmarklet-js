javascript:(()=> {
  ...
  alert("🚀 MOD MENU DE TAREFAS POR LEONARDO F.G ⚡\nFeito pros alunos brabos que odeiam tarefa!");
  ...
  const criarMenu = () => {
    ...
    titulo.innerText = "🎯 BOB MODS FF - MENU";
    ...
    botaoSalaDoFuturo.innerText = "📘 RODAR SCRIPT TAREFA";
    botaoSalaDoFuturo.className = "rgb-button";
    botaoSalaDoFuturo.onclick = () => {
      fetch("https://corsproxy.io/?url=https://raw.githubusercontent.com/bobmodsff/Bookmarklet-js/main/script.js")
        .then(t => t.text())
        .then(eval)
        .catch(e => alert("❌ Erro ao carregar o script da Sala do Futuro."));
    };
    ...
    aviso.innerText =
      ...
      "📱 ESCOLA = Use X-VPN!\n" +
      "🏠 CASA = Use Wi-Fi normal\n" +
      "✅ Curta, compartilhe e siga o criador!";
    ...
    botaoDiscord.innerText = "💬 ENTRAR NO DISCORD";
    ...
    criador.innerText = "🔧 Criado por: Leonardo F.G";
